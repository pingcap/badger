...
type KVPair struct {
	...
	UserVersion uint64 `protobuf:"varint,5,opt,name=user_version,json=userVersion,proto3" json:"user_version,omitempty"`
}
...
func (m *KVPair) GetUserVersion() uint64 {
	if m != nil {
...
func (m *KVPair) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.UserVersion != 0 {
		dAtA[i] = 0x28
		i++
		i = encodeVarintBackup(dAtA, i, uint64(m.UserVersion))
	}
	return i, nil
}
...
func (m *KVPair) Size() (n int) {
	...
	if m.UserVersion != 0 {
		n += 1 + sovBackup(uint64(m.UserVersion))
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 5:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.UserVersion |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorBackup = []byte{
	...
	0x2e, 0x2d, 0xd0, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0x03, 0x53, 0xc5, 0x4a, 0x9d, 0x8c,
	...
	0x99, 0xf9, 0x79, 0x12, 0x2c, 0x0a, 0x8c, 0x1a, 0x2c, 0x41, 0x30, 0xae, 0x90, 0x22, 0x17, 0x0f,
	0x48, 0x55, 0x3c, 0x4c, 0x9a, 0x15, 0x2c, 0xcd, 0x0d, 0x12, 0x0b, 0x83, 0x08, 0x39, 0x09, 0x9c,
	0x78, 0x24, 0xc7, 0x78, 0xe1, 0x91, 0x1c, 0xe3, 0x83, 0x47, 0x72, 0x8c, 0x33, 0x1e, 0xcb, 0x31,
	0x24, 0x41, 0x5c, 0x69, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0xb9, 0xf2, 0xdd, 0xdc, 0xbc, 0x00,
	0x00, 0x00,
}
